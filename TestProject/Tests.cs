...
namespace TestProject
{
    ...
    public class Tests
    {
        ...
        {
            Assert.AreEqual(decrypted, encryptor.DecryptFile(encryptedTxt));
        }

        [Test]
        public void EncryptTxt()
        {
            Assert.AreEqual(encrypted, encryptor.EncryptFile(decryptedTxt));
        }

        [Test]
        public void DecryptDocx()
        {
            Assert.AreEqual(decrypted, encryptor.DecryptFile(encryptedDocx));
        }

        [Test]
        public void EncryptDocx()
        {
            Assert.AreEqual(encrypted, encryptor.EncryptFile(decryptedDocx));
        }
    }
}